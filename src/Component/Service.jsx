...
<p className="pb-[2rem]">As a professional company, we are specialized to provide you the following services: </p>
    ...
    to realize your trading and commerce businesses in crude oil and refined petroleum products.</p>


{/* SLIDER */}
    <div className="flex w-[100%] ">
    <Slider className="justify-around items-center flex overflow-y-hidden  p-4 w-[100%] mx-auto overflow-x-hidden " {...settings}>
  {/* Slider 1 */}

  <div className="p-3    relative  flex flex-col  w-[200px] h-[200px]">
       <img src={marine} alt="slider_1"  className="w-[300px] h-[300px]" />
       <h1 className="text-white font-tekfont pl-2">Turkey</h1>
      </div>


      {/* Slider 2 */}
    
  <div className="p-3  justify-center items-center  relative  flex flex-col  w-[200px] h-[200px]">
      <img src={dredging} alt="slider_2"  className="w-[300px] h-[300px]" />
      <h1 className="text-white font-tekfont ">Turmenstian</h1>

      </div>


      {/* Slider 3 */}
      <div className="p-3 justify-center items-center   relative  flex flex-col  w-[200px] h-[0px]">
      <img src={vessel} alt="slider_3"  className="w-[300px] h-[300px]" />
      <h1 className="text-white font-tekfont ">Georgia</h1>
